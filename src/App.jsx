...
const workbenches = [
  ...
  },
  {
    ...
    metrics: ["覆盖 4 个运营模块", "接入 6 个业务数据源", "支持每日自动播报"],
    outcomes: [
      "集中展示用户、内容、客服售后和产品运营数据，减少在分散 Excel 表格中查找和汇总。",
      "支持自动采集有赞商城、私域大师、慧量 SCRM、企业微信、金山/WPS 与飞书群文件数据，并通过飞书每日播报，帮助团队及时掌握经营情况。",
...
const featuredCases = [
  {
    ...
    images: [
      {
        src: assetPath("chuntian-business-dashboard.webp"),
        alt: "春田鲜生数据中台用户运营业务数据页面",
        label: "业务数据页面",
        caption: "经营指标、客户结构与成交趋势集中展示",
      },
      {
        src: assetPath("chuntian-automation-logs.webp"),
  ...
  },
  {
    ...
    images: [
      {
        src: assetPath("seo-growth-dashboard.webp"),
        alt: "云瞻 SEO 控制中心增长看板总览",
        label: "SEO 控制中心总览",
        caption: "文章、收录、排名与注册贡献形成统一漏斗",
      },
      {
        src: assetPath("seo-keyword-dashboard.webp"),
  ...
  return (
    <section className="hero" id="hero" ref={ref}>
      <motion.img
        ...
        src={assetPath("organizational-constellation.webp")}
