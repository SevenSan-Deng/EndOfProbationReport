...
const workbenches = [
  {
    ...
    icon: UsersThree,
    summary:
      "把售后组、平台组和周报月报任务统一到一个网页入口，集中处理排队、调度、日志、失败重试和配置维护。",
    metrics: ["17 个任务定义", "7 个业务入口", "1 条串行任务队列"],
    outcomes: [
      "由两个独立服务收口为一个本地控制中心，减少页面、端口和脚本切换。",
      "任务串行执行，降低多人同时写入飞书表格、争用登录态和重复执行的风险。",
      "保留计划时间、队列位置、运行结果和脱敏日志，异常可追踪、可复盘。",
    ],
  },
  {
    name: "云瞻 SEO 控制中心",
    ...
    metrics: ["4 类分析任务", "主站、副站及 7 类自媒体", "6 项关键链路测试"],
    outcomes: [
      "完成 6 项关键链路测试，其中 1 项副站发布异常已修复并复测通过。",
      "新增 AI 审核、关键词范围、关键词匹配弹窗和模型选择，完善生成与发布控制能力。",
      "建立关键词、文章、发布链接、阅读、收录、排名与注册贡献之间的追踪链路。",
    ],
  },
  {
    name: "春田鲜生数据中台",
    ...
    metrics: ["4 个业务模块", "26 张业务表", "196 项自动化测试"],
    outcomes: [
      "飞书每日播报已接入工作台，用户运营板块完成有赞与客户数据获取。",
      "17 个只读接口验收通过，前端、后端、数据库、调度和 Windows 启停完成上线前审查。",
      "当前按有条件上线口径管理，源数据供给、登录态和任务分配正式化均有明确风险提示。",
    ],
  },
];
  ...
  return (
    <section className="section work" id="work">
      ...
      <div className="work-category-heading">
        ...
        <p>3 个跨流程系统，负责把数据、任务、日志与操作入口收口。</p>
      </div>
